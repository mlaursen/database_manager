...
public abstract class DatabaseObject {
	...
	/**
	 * Get an array of Object to be passed to a database procedure call.
	 * The array is generated by seraching for all the DatabaseField or MultipleDatabaseField
	 * annotations located in the class starting with the DatabaseObject and working down
	 * to the current class.
	 * @param proc	The procedure to get the parameters for
	 * @return
	 */
	...
	/**
	 * Takes a Map of interger position and objects and sorts them
	 * from 0 - max size of map into an array of objects
	 * @param map
	 * @return
	 */
	 ...
	 * If the database object is not GetAllable, it will return an empty list.
	 ...
	 * sub class. Searches
	 * for all DatabaseField annotations and calls the getters in order as 
	 * an array of objects to be passed to the delete procedure.
	 * @param primaryKey
	 * @param type	Sub class to cast to
	 * @return
	 */
	...
	/**
	 * Default implmenetation for a database object that is filterable.. Searches
	 * for all DatabaseField annotations and calls the getters in order as 
	 * an array of objects to be passed to the delete procedure.
	 * 
	...
	/**
	 * Default implementation for a updateable database object. Searches
	 * for all DatabaseField annotations and calls the getters in order as 
	 * an array of objects to be passed to the delete procedure.
	 * @return
	 */
	...
	/**
	 * Default implementation for a deleteable database object. Searches
	 * for all DatabaseField annotations and calls the getters in order as 
	 * an array of objects to be passed to the delete procedure.
	 * @return
	 */
