...
/**
 * This is an extention of a DatabaseObject.
 * The default implementation removes the "View" from the package name.
 * This is if the View uses the same database package as the source table(s)
...
public class DatabaseView extends DatabaseObject implements Getable {
	...
	/**
	 * This is if the get procedure name is different than
	 * the default "GET". The get method will still call
	 * the method by searching for GET, but the new name will
	 * be supplied to the Database
	 * @param newName
	 */
