...
public @interface DatabaseField {
	...
	/**
	 * Array of DatabaseFieldType to be applied to the field. The default is an array of just the GET type This and postion() are two linked
	 * arrays, the order of both matter
	 * 
